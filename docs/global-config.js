...
(function () {
  ...
  var REDIRECT_RULES = [
    ...
    { host: 'https://ganovel1.muaks.top',     threshold: 0.054 },
    { host: 'https://novel.rjjpd.top',        threshold: 0.055 },
    // 0~0.1% → cuvupa，0.1%~5.1% → hotelterdekat，5.1%~5.3% → newreadnovel，5.3%~5.4% → ganovel，5.4%~5.5% → rjjpd，5.5%~100% → 正常
  ];
